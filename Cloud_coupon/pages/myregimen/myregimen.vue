	...
	<view style="position: absolute;top: 0;bottom: 0;width: 100%;overflow: scroll;background: #F0F0F0;">
		...
		<view class="myreg_box">
			...
			<view class="myreg_ri">
				...
				<view class="text_el">还差<text>5</text>人可以领优惠券</view>
				<view class="myreg_pic">
					<view class="pic_list">
						<image src="../../static/images/logo.png"></image>
						<image src="../../static/images/logo.png"></image>
						<image src="../../static/images/logo.png"></image>
					</view>
					<view class="pic_btn">立即邀请</view>
				</view>
			</view>
		</view>
